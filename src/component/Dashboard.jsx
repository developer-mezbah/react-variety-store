    ...
    <div>
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-400">
            This is what we've got for your today.
          </p>
        </div>
      ...
      <div className="grid lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5 mt-10">
        <div
          ...
          style={{
            background: `url(${partners}) bottom right / 70px 70px no-repeat #393e46`,
          }}
        >
        ...
        <div
          className="bg-cardBg p-6 rounded-3xl"
          style={{
            background: `url(${customer}) bottom right / 70px 70px no-repeat #393e46`,
          }}
        >
          <h4 className={"text-2xl text-textColor"}>Members onsite</h4>
          <span className="text-xl text-themeColor mt-5">100</span>
        ...
        <div
          className="bg-cardBg p-6 rounded-3xl"
          style={{
            background: `url(${pen}) bottom right / 70px 70px no-repeat #393e46`,
          }}
        >
          <h4 className={"text-2xl text-textColor"}>Members onsite</h4>
          <span className="text-xl text-themeColor mt-5">100</span>
        ...
        <div
          className="bg-cardBg p-6 rounded-3xl"
          style={{
            background: `url(${mixer}) bottom right / 50px 50px no-repeat #393e46`,
          }}
        >
          <h4 className={"text-2xl text-textColor"}>Members onsite</h4>
          <span className="text-xl text-themeColor mt-5">100</span>
