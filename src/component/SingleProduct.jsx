...
export function SinglePrduct({data}) {
  return (
    <Card
      ...
      imgSrc={data?.img}
    >
      <Link className="group" to={`/product-details/${data._id}`}>
        <h5 className="text-xl font-semibold tracking-tight text-gray-900 group-hover:text-themeColor truncate">
         {data?.name}
        </h5>
      </Link>
      ...
      <div className="flex items-center justify-between">
        <span className="text-3xl font-bold text-gray-900 dark:text-white price">${data?.price}</span>
        <Link
